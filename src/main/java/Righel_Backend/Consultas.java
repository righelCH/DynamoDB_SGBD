...
//            ItemCollection<QueryOutcome> items = table.query(querySpec);
//
//            // Inicializar los StringBuilder para los resultados
...
//                jsonResultString.append(item.toJSONPretty()).append("\n");
//
//                // Formatear los atributos de forma limpia
...
//            }
//
//            // Mostrar los resultados en el JTextArea correspondiente
//            jsonResultArea.setText(jsonResultString.toString());
//            if (cleanResultString.length() > 0) {
...
//            // Manejar excepciones de DynamoDB
//            if (e.getErrorCode().equals("ResourceNotFoundException")) {
//                jsonResultArea.setText("La tabla no se encontró.");
//                cleanResultArea.setText("La tabla no se encontró.");
//            } else {
...
//            // Procesar los resultados
//            for (Item item : items) {
//                // Convertir Item a un Map<String, Object> para Gson
//                resultsList.add(item.asMap());
//            }
//
//            // Convertir la lista de resultados a JSON con formato bonito
//            Gson gson = new GsonBuilder().setPrettyPrinting().create();
//            String jsonOutput = gson.toJson(resultsList);
//
//            // Mostrar el JSON real en el JTextArea
//            jsonResultArea.setText(jsonOutput);
//            
//            // Si no hay resultados, mostrar mensaje claro
//            if (resultsList.isEmpty()) {
//                cleanResultArea.setText("No se encontraron resultados.");
//            } else {
//                cleanResultArea.setText("Consulta exitosa. Datos disponibles en formato JSON.");
//            }
//
//        } catch (AmazonDynamoDBException e) {
//            jsonResultArea.setText("Error de DynamoDB: " + e.getMessage());
